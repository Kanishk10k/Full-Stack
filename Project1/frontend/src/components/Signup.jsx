...
const Signup = () => {
    ...
    return (
        <div className='flex w-[90%] h-4/5 justify-between items-center bg-white shadow-2xl shadow-green-600'>
            ...
            <h1 className='text-3xl font-semibold text-center h-1/3 flex items-center justify-center'>SignUp !</h1>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button className='p-2 w-[70%] my-4 font-medium text-green-500 shadow bg-indigo-800 rounded-full active:bg-green-500 active:text-indigo-800'>{isLoading ? "Loading" : "Sign-up"}</button>
                </form>
            </div>
        </div>
    )
