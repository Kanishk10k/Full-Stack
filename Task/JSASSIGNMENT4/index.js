...
// let para=document.getElementById("p1").addEventListener("click",function(){
//     let data=document.getElementById("p1");
//     data.innerHTML="hey,this hardik welcome to my place"
//     console.log("hello")
...
// let div2=document.getElementById("div1").addEventListener("mouseover",function(){
//     let data=document.getElementById("div1");
...
// let ul2=document.getElementById("ul1").addEventListener("click",function(){
//     let data=document.createElement('li');
//     data.innerHTML="<li>1. mango<li/> <li>2. Apple<li/> <li>3. Orange<li/>"
